...
class TestCredential(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_credential = Credential('Wenslaus','Instagram','Makumba','@!#') # create new credential object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credential.name,'Wenslaus')
        self.assertEqual(self.new_credential.social_media,'Instagram')
        self.assertEqual(self.new_credential.user_name,'Makumba')
    ...
    def test_save_multiple_credential(self):
        ...
        test_credential = Credential('Makumba','Snapchat','Makumba','abcd')
    ...
    def test_find_credential_by_user_name(self):
        ...
        found_credential = Credential.find_by_user_name('Makumba')
