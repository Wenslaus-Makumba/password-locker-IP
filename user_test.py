...
class TestUser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_user = User('Wenslaus','Makumba','#?/','makumbaw@gmail.com') #create new user account object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_user.first_name,'Wenslaus')
        self.assertEqual(self.new_user.last_name,'Makumba')
        self.assertEqual(self.new_user.password,'#?/')
        self.assertEqual(self.new_user.email,'makumbaw@gmail.com')
    ...
    def test_save_multiple_user(self):
        ...
        test_user = User('Wenslaus','Makumba','&*&*','makumbaw@gmail.com')
        test_user.save_user()
    ...
    def test_find_user_by_first_name(self):
        ...
        found_user = User.find_by_first_name('Wenslaus')
